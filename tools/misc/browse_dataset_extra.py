...
def show_det_data(input, out_dir, show=False):
    ...
    print()
    print(input['img_metas']._data['pts_filename'])
    ...
    for i in range(len(cur_gt_bboxes)):
        ...
        if input['gt_labels_3d']._data[i].item()==1 and gt_bbox[5]>=1:
            ...
            gt_bbox[4]=0
            gt_bbox[5]=0
        elif input['gt_labels_3d']._data[i].item()==0 and gt_bbox[5]>=1:
            gt_bbox[3]=0
            gt_bbox[4]=0
            gt_bbox[5]=0
        elif input['gt_labels_3d']._data[i].item()!=-1:
            cnt+=1
