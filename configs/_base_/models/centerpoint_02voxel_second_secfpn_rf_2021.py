...
model = dict(
    ...
    pts_voxel_layer=dict(
        ...
        point_cloud_range=[-60, -100.0, -3, 61.6, 60, 1],
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            pc_range=[-60, -100.0, -3, 61.6, 60, 1],
            post_center_range=[-60, -100.0, -3, 61.6, 60, 1],
            max_num=500,
            score_threshold=0.1,
            out_size_factor=8,
    ...
    test_cfg=dict(
        pts=dict(
            point_cloud_range=[-60, -100.0, -3, 61.6, 60, 1],
            post_center_limit_range=[-60, -100.0, -3, 61.6, 60, 1],
            max_per_img=500,
            max_pool_nms=False,
